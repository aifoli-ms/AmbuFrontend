  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white flex flex-col p-6">
      <div className="flex-1 flex flex-col items-center max-w-md w-full mx-auto">
        ...
        >
          <h2 className="mb-2">No Internet?</h2>
          <p className="text-gray-600 max-w-sm">
            Call 112 directly for emergency ambulance service.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="text-lg">Call 112</span>
            <span className="text-xs text-red-100">National Emergency Number</span>
          </Button>
